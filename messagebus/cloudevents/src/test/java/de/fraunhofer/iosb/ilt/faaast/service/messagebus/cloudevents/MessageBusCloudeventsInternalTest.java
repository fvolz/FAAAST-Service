...
public class MessageBusCloudeventsInternalTest extends AbstractMessageBusCloudeventsTest<Void> {
    ...
    @Override
    protected Void startServer(MessageBusCloudeventsConfig config) {
        return null;
    }
